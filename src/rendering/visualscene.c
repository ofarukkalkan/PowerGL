...
void powergl_build_scene_from_dae( powergl_rendering_visualscene *this, const char *file )
{
#if DEBUG_OUTPUT
    printf( "%s\n", __func__ );
...
void powergl_add_object_into_scene( powergl_rendering_visualscene *scene, powergl_rendering_object *obj)
{
    scene->objects = powergl_resize(scene->objects, sizeof(powergl_rendering_object*) * ++scene->n_object);
