...
struct powergl_collada_core_COLLADA_t
{
    ...
    char* c_xmlns;
    size_t n_xmlns;
    powergl_collada_core_library_geometries** c_library_geometries;
    size_t n_library_geometries;
    powergl_collada_core_library_cameras** c_library_cameras;
    size_t n_library_cameras;
    powergl_collada_core_library_lights** c_library_lights;
    size_t n_library_lights;
    powergl_collada_core_library_visual_scenes** c_library_visual_scenes;
    size_t n_library_visual_scenes;
    powergl_collada_core_scene** c_scene;
    size_t n_scene;
};
struct powergl_collada_core_library_visual_scenes_t
{
    ...
    char* c_name;
    size_t n_name;
    powergl_collada_core_visual_scene** c_visual_scene;
    size_t n_visual_scene;
};
struct powergl_collada_core_library_cameras_t
{
    ...
    char* c_name;
    size_t n_name;
    powergl_collada_core_camera** c_camera;
    size_t n_camera;
};
struct powergl_collada_core_library_lights_t
{
    ...
    char* c_name;
    size_t n_name;
    powergl_collada_core_light** c_light;
    size_t n_light;
};
struct powergl_collada_core_library_geometries_t
{
    ...
    char* c_name;
    size_t n_name;
    powergl_collada_core_geometry** c_geometry;
    size_t n_geometry;
};
struct powergl_collada_core_scene_t
{
    dom_connector dom;
    powergl_collada_core_InstanceWithExtra** c_instance_visual_scene;
    size_t n_instance_visual_scene;
};
struct powergl_collada_core_visual_scene_t
{
    ...
    char* c_name;
    size_t n_name;
    powergl_collada_core_node** c_node;
    size_t n_node;
};
struct powergl_collada_core_geometry_t
{
    ...
    char* c_name;
    size_t n_name;
    powergl_collada_core_mesh** c_mesh;
    size_t n_mesh;
};
struct powergl_collada_core_mesh_t
{
    dom_connector dom;
    powergl_collada_core_source** c_source;
    size_t n_source;
    powergl_collada_core_vertices** c_vertices;
    size_t n_vertices;
    powergl_collada_core_triangles** c_triangles;
    size_t n_triangles;
};
struct powergl_collada_core_source_t
{
    ...
    char* c_name;
    size_t n_name;
    powergl_collada_core_float_array** c_float_array;
    size_t n_float_array;
    powergl_collada_core_int_array** c_int_array;
    size_t n_int_array;
    powergl_collada_core_source_technique_common** c_technique_common;
    size_t n_technique_common;
};
struct powergl_collada_core_accessor_t
{
    ...
    size_t c_offset;
    size_t c_stride;
    powergl_collada_core_param** c_param;
    size_t n_param;
...
struct powergl_collada_core_vertices_t
{
    ...
    char* c_name;
    size_t n_name;
    powergl_collada_core_input_local** c_input;
    size_t n_input;
};
struct powergl_collada_core_triangles_t
{
    ...
    size_t n_name;
    size_t c_count;
    powergl_collada_core_input_local_offset** c_input;
    size_t n_input;
    powergl_collada_core_ListOfUInts** c_p;
    size_t n_p;
};
struct powergl_collada_core_light_t
{
    ...
    char* c_name;
    size_t n_name;
    powergl_collada_core_light_technique_common** c_technique_common;
    size_t n_technique_common;
};
struct powergl_collada_core_directional_t
{
    dom_connector dom;
    powergl_collada_core_targetable_floats** c_color;
    size_t n_color;
};
struct powergl_collada_core_camera_t
{
    ...
    char* c_name;
    size_t n_name;
    powergl_collada_core_optics** c_optics;
    size_t n_optics;
};
struct powergl_collada_core_optics_t
{
    dom_connector dom;
    powergl_collada_core_optics_technique_common** c_technique_common;
    size_t n_technique_common;
};
struct powergl_collada_core_perspective_t
{
    dom_connector dom;
    powergl_collada_core_targetable_float** c_xfov;
    size_t n_xfov;
    powergl_collada_core_targetable_float** c_yfov;
    size_t n_yfov;
    powergl_collada_core_targetable_float** c_aspect_ratio;
    size_t n_aspect_ratio;
    powergl_collada_core_targetable_float** c_znear;
    size_t n_znear;
    powergl_collada_core_targetable_float** c_zfar;
    size_t n_zfar;
};
struct powergl_collada_core_node_t
{
    ...
    char* c_name;
    size_t n_name;
    powergl_collada_core_targetable_floats** c_matrix;
    size_t n_matrix;
    powergl_collada_core_InstanceWithExtra** c_instance_camera;
    size_t n_instance_camera;
    powergl_collada_core_InstanceWithExtra** c_instance_light;
    size_t n_instance_light;
    powergl_collada_core_InstanceWithExtra** c_instance_geometry;
    size_t n_instance_geometry;
};
struct powergl_collada_core_source_technique_common_t
{
    dom_connector dom;
    powergl_collada_core_accessor** c_accessor;
    size_t n_accessor;
};
struct powergl_collada_core_light_technique_common_t
{
    dom_connector dom;
    powergl_collada_core_directional** c_directional;
    size_t n_directional;
};
struct powergl_collada_core_optics_technique_common_t
{
    dom_connector dom;
    powergl_collada_core_perspective** c_perspective;
    size_t n_perspective;
};
...
struct powergl_collada_core_input_local_offset_t
{
    ...
    size_t c_set;
    size_t c_offset;
    powergl_collada_core_source* r_source;
