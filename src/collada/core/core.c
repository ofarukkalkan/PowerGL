...
void parse_attrib_collada_core_COLLADA(void *obj, size_t index, const char *value)
{
    ...
    switch(index)
        {
        case 0:
            powergl_collada_parse_attrib(this->dom.nodes, index, value);
...
void add_child_collada_core_COLLADA(void *obj, size_t index, dom_connector *child)
{
    ...
    switch(index)
        {
        case 0:
            powergl_collada_add_child(this->dom.nodes, index, child);
            break;
        case 1:
            powergl_collada_add_child(this->dom.nodes, index, child);
            break;
...
{
    powergl_collada_core_COLLADA *this = powergl_resize(NULL, sizeof(powergl_collada_core_COLLADA));
    this->c_version = NULL;
    this->n_version = 0;
    this->c_xmlns = NULL;
    this->n_xmlns = 0;
    this->c_library_geometries = NULL;
    this->n_library_geometries = 0;
    this->c_library_cameras = NULL;
    this->n_library_cameras = 0;
    this->c_library_lights = NULL;
    this->n_library_lights = 0;
    this->c_library_visual_scenes = NULL;
...
{
    powergl_collada_core_library_visual_scenes *this = powergl_resize(NULL, sizeof(powergl_collada_core_library_visual_scenes));
    this->c_id = NULL;
    this->n_id = 0;
    this->c_name = NULL;
    this->n_name = 0;
    this->c_visual_scene = NULL;
...
{
    powergl_collada_core_library_cameras *this = powergl_resize(NULL, sizeof(powergl_collada_core_library_cameras));
    this->c_id = NULL;
    this->n_id = 0;
    this->c_name = NULL;
    this->n_name = 0;
...
{
    powergl_collada_core_library_lights *this = powergl_resize(NULL, sizeof(powergl_collada_core_library_lights));
    this->c_id = NULL;
    this->n_id = 0;
    this->c_name = NULL;
    this->n_name = 0;
...
{
    powergl_collada_core_library_geometries *this = powergl_resize(NULL, sizeof(powergl_collada_core_library_geometries));
    this->c_id = NULL;
    this->n_id = 0;
    this->c_name = NULL;
    this->n_name = 0;
    this->c_geometry = NULL;
    this->n_geometry = 0;
    this->dom.nodes = NULL;
...
{
    powergl_collada_core_scene *this = powergl_resize(NULL, sizeof(powergl_collada_core_scene));
    this->c_instance_visual_scene = NULL;
    this->n_instance_visual_scene = 0;
    this->dom.nodes = NULL;
...
{
    powergl_collada_core_visual_scene *this = powergl_resize(NULL, sizeof(powergl_collada_core_visual_scene));
    this->c_id = NULL;
    this->n_id = 0;
    this->c_name = NULL;
    this->n_name = 0;
...
{
    powergl_collada_core_geometry *this = powergl_resize(NULL, sizeof(powergl_collada_core_geometry));
    this->c_id = NULL;
    this->n_id = 0;
    this->c_name = NULL;
    this->n_name = 0;
...
{
    powergl_collada_core_mesh *this = powergl_resize(NULL, sizeof(powergl_collada_core_mesh));
    this->c_source = NULL;
    this->n_source = 0;
    this->c_vertices = NULL;
    this->n_vertices = 0;
...
{
    powergl_collada_core_source *this = powergl_resize(NULL, sizeof(powergl_collada_core_source));
    this->c_id = NULL;
    this->n_id = 0;
    this->c_name = NULL;
    this->n_name = 0;
    this->c_float_array = NULL;
    this->n_float_array = 0;
    this->c_int_array = NULL;
    this->n_int_array = 0;
    this->c_technique_common = NULL;
    this->n_technique_common = 0;
    this->dom.nodes = NULL;
...
void set_ref_collada_core_accessor(void *obj, size_t index, dom_connector *ptr)
{
    ...
    switch(index)
        {
        case 5:
            powergl_collada_set_ref(this->dom.nodes, index, ptr);
...
{
    powergl_collada_core_accessor *this = powergl_resize(NULL, sizeof(powergl_collada_core_accessor));
    this->c_source = NULL;
    this->n_source = 0;
    this->c_count = 0;
    this->c_offset = 0;
...
{
    powergl_collada_core_param *this = powergl_resize(NULL, sizeof(powergl_collada_core_param));
    this->c_sid = NULL;
    this->n_sid = 0;
    this->c_name = NULL;
    this->n_name = 0;
...
void parse_content_collada_core_float_array(void *obj, size_t index, const char *value)
{
    ...
    switch(index)
        {
        case 0:
            powergl_collada_parse_content(this->dom.nodes, index, value);
...
{
    powergl_collada_core_float_array *this = powergl_resize(NULL, sizeof(powergl_collada_core_float_array));
    this->content = NULL;
    this->n_content = 0;
    this->c_id = NULL;
    this->n_id = 0;
...
{
    powergl_collada_core_int_array *this = powergl_resize(NULL, sizeof(powergl_collada_core_int_array));
    this->content = NULL;
    this->n_content = 0;
    this->c_id = NULL;
    this->n_id = 0;
...
{
    powergl_collada_core_vertices *this = powergl_resize(NULL, sizeof(powergl_collada_core_vertices));
    this->c_id = NULL;
    this->n_id = 0;
    this->c_name = NULL;
    this->n_name = 0;
...
{
    powergl_collada_core_triangles *this = powergl_resize(NULL, sizeof(powergl_collada_core_triangles));
    this->c_name = NULL;
    this->n_name = 0;
    this->c_count = 0;
    this->c_input = NULL;
...
{
    powergl_collada_core_light *this = powergl_resize(NULL, sizeof(powergl_collada_core_light));
    this->c_id = NULL;
    this->n_id = 0;
    this->c_name = NULL;
    this->n_name = 0;
...
{
    powergl_collada_core_directional *this = powergl_resize(NULL, sizeof(powergl_collada_core_directional));
    this->c_color = NULL;
    this->n_color = 0;
    this->dom.nodes = NULL;
...
{
    powergl_collada_core_camera *this = powergl_resize(NULL, sizeof(powergl_collada_core_camera));
    this->c_id = NULL;
    this->n_id = 0;
    this->c_name = NULL;
    this->n_name = 0;
...
{
    powergl_collada_core_optics *this = powergl_resize(NULL, sizeof(powergl_collada_core_optics));
    this->c_technique_common = NULL;
    this->n_technique_common = 0;
    this->dom.nodes = NULL;
...
{
    powergl_collada_core_perspective *this = powergl_resize(NULL, sizeof(powergl_collada_core_perspective));
    this->c_xfov = NULL;
    this->n_xfov = 0;
    this->c_yfov = NULL;
    this->n_yfov = 0;
    this->c_aspect_ratio = NULL;
    this->n_aspect_ratio = 0;
    this->c_znear = NULL;
    this->n_znear = 0;
    this->c_zfar = NULL;
    this->n_zfar = 0;
...
{
    powergl_collada_core_node *this = powergl_resize(NULL, sizeof(powergl_collada_core_node));
    this->c_id = NULL;
    this->n_id = 0;
    this->c_sid = NULL;
    this->n_sid = 0;
    ...
    this->c_matrix = NULL;
    this->n_matrix = 0;
    this->c_instance_camera = NULL;
    this->n_instance_camera = 0;
    this->c_instance_light = NULL;
    this->n_instance_light = 0;
    this->c_instance_geometry = NULL;
...
{
    powergl_collada_core_source_technique_common *this = powergl_resize(NULL, sizeof(powergl_collada_core_source_technique_common));
...
{
    powergl_collada_core_light_technique_common *this = powergl_resize(NULL, sizeof(powergl_collada_core_light_technique_common));
    this->c_directional = NULL;
    this->n_directional = 0;
    this->dom.nodes = NULL;
...
{
    powergl_collada_core_optics_technique_common *this = powergl_resize(NULL, sizeof(powergl_collada_core_optics_technique_common));
    this->c_perspective = NULL;
    this->n_perspective = 0;
    this->dom.nodes = NULL;
...
{
    powergl_collada_core_InstanceWithExtra *this = powergl_resize(NULL, sizeof(powergl_collada_core_InstanceWithExtra));
    this->c_sid = NULL;
    this->n_sid = 0;
    this->c_name = NULL;
    this->n_name = 0;
...
{
    powergl_collada_core_input_local_offset *this = powergl_resize(NULL, sizeof(powergl_collada_core_input_local_offset));
    this->c_semantic = NULL;
    this->n_semantic = 0;
    this->c_source = NULL;
    this->n_source = 0;
...
{
    powergl_collada_core_input_local *this = powergl_resize(NULL, sizeof(powergl_collada_core_input_local));
    this->c_semantic = NULL;
    this->n_semantic = 0;
    this->c_source = NULL;
    this->n_source = 0;
...
{
    powergl_collada_core_ListOfUInts *this = powergl_resize(NULL, sizeof(powergl_collada_core_ListOfUInts));
    this->content = NULL;
    this->n_content = 0;
    this->dom.nodes = NULL;
...
{
    powergl_collada_core_targetable_floats *this = powergl_resize(NULL, sizeof(powergl_collada_core_targetable_floats));
    this->content = NULL;
    this->n_content = 0;
    this->c_sid = NULL;
    this->n_sid = 0;
...
{
    powergl_collada_core_targetable_float *this = powergl_resize(NULL, sizeof(powergl_collada_core_targetable_float));
    this->content = NULL;
    this->n_content = 0;
    this->c_sid = NULL;
    this->n_sid = 0;
...
static void support_collada_core_type_COLLADA_COLLADA()
{
    ...
    g_supported_collada_core_types[0].name = powergl_resize(NULL, size);
    ...
    g_supported_collada_core_types[0].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_COLLADA_library_visual_scenes()
{
    ...
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[1].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[1].name, str, size * sizeof(char));
    char str_parent[] = "COLLADA";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[1].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_COLLADA_library_cameras()
{
    ...
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[2].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[2].name, str, size * sizeof(char));
    char str_parent[] = "COLLADA";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[2].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_COLLADA_library_lights()
{
    ...
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[3].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[3].name, str, size * sizeof(char));
    char str_parent[] = "COLLADA";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[3].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_COLLADA_library_geometries()
{
    ...
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[4].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[4].name, str, size * sizeof(char));
    char str_parent[] = "COLLADA";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[4].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_COLLADA_scene()
{
    char str[] = "scene";
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[5].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[5].name, str, size * sizeof(char));
    char str_parent[] = "COLLADA";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[5].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_library_visual_scenes_visual_scene()
{
    ...
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[6].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[6].name, str, size * sizeof(char));
    char str_parent[] = "library_visual_scenes";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[6].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_library_geometries_geometry()
{
    char str[] = "geometry";
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[7].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[7].name, str, size * sizeof(char));
    char str_parent[] = "library_geometries";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[7].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_geometry_mesh()
{
    char str[] = "mesh";
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[8].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[8].name, str, size * sizeof(char));
    char str_parent[] = "geometry";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[8].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_mesh_source()
{
    char str[] = "source";
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[9].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[9].name, str, size * sizeof(char));
    char str_parent[] = "mesh";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[9].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_technique_common_accessor()
{
    char str[] = "accessor";
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[10].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[10].name, str, size * sizeof(char));
    char str_parent[] = "technique_common";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[10].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_accessor_param()
{
    char str[] = "param";
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[11].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[11].name, str, size * sizeof(char));
    char str_parent[] = "accessor";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[11].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_source_float_array()
{
    ...
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[12].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[12].name, str, size * sizeof(char));
    char str_parent[] = "source";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[12].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_source_int_array()
{
    char str[] = "int_array";
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[13].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[13].name, str, size * sizeof(char));
    char str_parent[] = "source";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[13].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_mesh_vertices()
{
    char str[] = "vertices";
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[14].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[14].name, str, size * sizeof(char));
    char str_parent[] = "mesh";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[14].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_mesh_triangles()
{
    char str[] = "triangles";
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[15].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[15].name, str, size * sizeof(char));
    char str_parent[] = "mesh";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[15].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_library_lights_light()
{
    char str[] = "light";
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[16].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[16].name, str, size * sizeof(char));
    char str_parent[] = "library_lights";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[16].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_technique_common_directional()
{
    ...
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[17].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[17].name, str, size * sizeof(char));
    char str_parent[] = "technique_common";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[17].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_library_cameras_camera()
{
    char str[] = "camera";
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[18].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[18].name, str, size * sizeof(char));
    char str_parent[] = "library_cameras";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[18].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_camera_optics()
{
    char str[] = "optics";
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[19].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[19].name, str, size * sizeof(char));
    char str_parent[] = "camera";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[19].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_technique_common_perspective()
{
    ...
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[20].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[20].name, str, size * sizeof(char));
    char str_parent[] = "technique_common";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[20].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_visual_scene_node()
{
    char str[] = "node";
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[21].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[21].name, str, size * sizeof(char));
    char str_parent[] = "visual_scene";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[21].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_0_source_technique_common()
{
    ...
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[22].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[22].name, str, size * sizeof(char));
    char str_parent[] = "0";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[22].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_0_light_technique_common()
{
    ...
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[23].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[23].name, str, size * sizeof(char));
    char str_parent[] = "0";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[23].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_0_optics_technique_common()
{
    ...
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[24].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[24].name, str, size * sizeof(char));
    char str_parent[] = "0";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[24].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_0_InstanceWithExtra()
{
    ...
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[25].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[25].name, str, size * sizeof(char));
    char str_parent[] = "0";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[25].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_0_input_local_offset()
{
    ...
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[26].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[26].name, str, size * sizeof(char));
    char str_parent[] = "0";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[26].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_0_input_local()
{
    ...
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[27].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[27].name, str, size * sizeof(char));
    char str_parent[] = "0";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[27].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_0_ListOfUInts()
{
    ...
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[28].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[28].name, str, size * sizeof(char));
    char str_parent[] = "0";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[28].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_0_targetable_floats()
{
    ...
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[29].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[29].name, str, size * sizeof(char));
    char str_parent[] = "0";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[29].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_0_targetable_float()
{
    ...
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[30].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[30].name, str, size * sizeof(char));
    char str_parent[] = "0";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[30].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_source_technique_common()
{
    ...
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[31].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[31].name, str, size * sizeof(char));
    char str_parent[] = "source";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[31].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_light_technique_common()
{
    char str[] = "technique_common";
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[32].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[32].name, str, size * sizeof(char));
    char str_parent[] = "light";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[32].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_optics_technique_common()
{
    char str[] = "technique_common";
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[33].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[33].name, str, size * sizeof(char));
    char str_parent[] = "optics";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[33].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_triangles_input()
{
    char str[] = "input";
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[34].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[34].name, str, size * sizeof(char));
    char str_parent[] = "triangles";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[34].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_vertices_input()
{
    char str[] = "input";
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[35].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[35].name, str, size * sizeof(char));
    char str_parent[] = "vertices";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[35].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_node_instance_camera()
{
    ...
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[36].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[36].name, str, size * sizeof(char));
    char str_parent[] = "node";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[36].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_node_instance_geometry()
{
    ...
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[37].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[37].name, str, size * sizeof(char));
    char str_parent[] = "node";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[37].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_node_instance_light()
{
    ...
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[38].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[38].name, str, size * sizeof(char));
    char str_parent[] = "node";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[38].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_scene_instance_visual_scene()
{
    ...
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[39].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[39].name, str, size * sizeof(char));
    char str_parent[] = "scene";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[39].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_triangles_p()
{
    char str[] = "p";
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[40].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[40].name, str, size * sizeof(char));
    char str_parent[] = "triangles";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[40].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_directional_color()
{
    char str[] = "color";
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[41].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[41].name, str, size * sizeof(char));
    char str_parent[] = "directional";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[41].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_node_matrix()
{
    char str[] = "matrix";
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[42].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[42].name, str, size * sizeof(char));
    char str_parent[] = "node";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[42].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_perspective_xfov()
{
    char str[] = "xfov";
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[43].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[43].name, str, size * sizeof(char));
    char str_parent[] = "perspective";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[43].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_perspective_yfov()
{
    char str[] = "yfov";
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[44].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[44].name, str, size * sizeof(char));
    char str_parent[] = "perspective";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[44].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_perspective_aspect_ratio()
{
    ...
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[45].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[45].name, str, size * sizeof(char));
    char str_parent[] = "perspective";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[45].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_perspective_znear()
{
    char str[] = "znear";
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[46].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[46].name, str, size * sizeof(char));
    char str_parent[] = "perspective";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[46].parent = powergl_resize(NULL, size);
...
static void support_collada_core_type_perspective_zfar()
{
    char str[] = "zfar";
    size_t size = sizeof str / sizeof(char);
    g_supported_collada_core_types[47].name = powergl_resize(NULL, size);
    memcpy(g_supported_collada_core_types[47].name, str, size * sizeof(char));
    char str_parent[] = "perspective";
    size = sizeof str_parent / sizeof(char);
    g_supported_collada_core_types[47].parent = powergl_resize(NULL, size);
